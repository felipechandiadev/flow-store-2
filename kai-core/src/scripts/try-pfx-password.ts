 ...
 *
 * Uso:
 *   cd kai-core && npm run fiscal:try-pfx-password -- ../envs/certs/10708387-1.pfx 'Marce-1070'
 *   cd kai-core && npm run fiscal:try-pfx-password -- ../envs/certs/10708387-1.pfx 'pass1' 'pass2'
 *   cd kai-core && npm run fiscal:try-pfx-password -- ../envs/certs/10708387-1.pfx --variations 'Marce-1070'
 */
