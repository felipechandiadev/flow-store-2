...
export class Company {
  ...
  /**
   * Vertical comercial de la empresa (no confundir con KAI_PRODUCT del deploy).
   * Valores: kaistore | kaifood | kaiservices.
   */
  @Column({ name: 'kai_product', type: 'varchar', length: 20, default: 'kaistore' })
