...
import type { DeliveryOrderStatus, DeliverySourceChannel } from './delivery.types';

@Entity('delivery_orders')
@Index('idx_delivery_orders_company_status', ['companyId', 'deliveryStatus'])
@Index('uq_delivery_orders_transaction', ['transactionId'], { unique: true })
export class EShopDeliveryOrder {
  ...
  /** Canal de origen: checkout eShop o venta POS. */
  @Column({ name: 'source_channel', type: 'varchar', length: 16, default: 'ESHOP' })
