...
describe('buildDiningBoardSnapshot', () => {
  ...
  it('puts SENT fires in PREPARING and READY_FOR_PICKUP fires in READY column', () => {
    const snapshot = buildDiningBoardSnapshot({
      ...
      orders: [
          ...
          lines: [
            {
              ...
              kitchenStatus: KitchenItemStatus.READY_FOR_PICKUP,
        ...
        },
        {
          ...
          displayLabel: 'Para llevar #kitchen-only',
          profile: { customerName: 'Solo cocina' },
          lines: [
            {
              id: 'l3',
              kitchenFireId: 'fire-3',
              kitchenFireNumber: 58,
              kitchenStatus: KitchenItemStatus.READY,
              readyAt: '2026-07-22T12:06:00.000Z',
            },
          ],
        },
      ],
