...
export async function listCashHubsForDepositAction(cashSessionId: string) {
  ...
  return CashSessionsRequest.listCashHubsForDeposit(id);
}

export async function depositCashFromHubAction(input: {
  ...
  return CashSessionsRequest.depositCashFromHub(cashSessionId, {
    cashHubId,
    amount,
    userId,
    reason: input.reason,
