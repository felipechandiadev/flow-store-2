...
const Select: React.FC<SelectProps> = ({ label, options, placeholder, value = null, onChange, required = false, name, variant = 'default', density: _density = "default", allowClear = false, disabled = false, hideDropdownIcon = false, className = '', alwaysShowLabel = false, ...props }) => {
