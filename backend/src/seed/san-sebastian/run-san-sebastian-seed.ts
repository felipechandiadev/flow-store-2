...
import {
  ensureSeedSchemaPatches,
  ensureProductVariantUomTripletColumns,
  ensurePointsOfSaleStorageColumn,
  ensureStockLevelThresholdColumns,
  ensureProductVariantShippingColumns,
  ensureBrandsTableAndProductBrandId,
} from '../shared/seed-bootstrap.util';
...
async function bootstrap() {
  ...
  try {
    ...
    // Seed aditivo: no truncar otras empresas/datos del entorno dev.
