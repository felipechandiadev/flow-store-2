...
export const DOCUMENT_PREFIXES: Record<TransactionType, string> = {
  ...
  [TransactionType.SUPPLIER_HONORARIUM_RECEIPT]: 'BOLETA-HONORARIOS-PROVEEDOR-',
  ...
  [TransactionType.PAYROLL_PAYMENT]: 'PAGO-NOMINA-',
  [TransactionType.EXPENSE_PAYMENT]: 'PAGO-GASTO-',
  [TransactionType.BANK_TO_CASH_TRANSFER]: 'GIRO-BANCO-CAJA-',
  ...
  [TransactionType.CASH_SESSION_TO_HUB_TRANSFER]: 'TRASLADO-CAJA-HUB-',
