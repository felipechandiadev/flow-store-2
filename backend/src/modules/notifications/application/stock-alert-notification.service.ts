...
/**
 * Publica alertas de stock tras movimientos de inventario (p. ej. pwa-stock /inventory/adjust).
...
export class StockAlertNotificationService {
  ...
  async publishForVariantStorage(params: {
    ...
    /** Stock físico tras el movimiento (p. ej. ajuste absoluto desde pwa-stock). */
