...
@Entity('e_shop_delivery_order_line_picks')
@Index('uq_e_shop_delivery_order_line_picks', ['companyId', 'deliveryOrderId', 'transactionLineId'], {
  unique: true,
})
@Index('idx_e_shop_delivery_order_line_picks_order', ['companyId', 'deliveryOrderId'])
