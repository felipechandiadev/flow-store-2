...
export default async function SiiContribuyentePage() {
  ...
  if (!company) {
    return (
      <SiiNarrowContent>
        <BasicPageLayout title="Contribuyente SII" subtitle="Datos del emisor y resolución">
