...
import type { PurchasingReportSeries } from "@/features/purchasing-reports/types/purchasing-report.types";
...
function isCountSeries(series: PurchasingReportSeries): boolean {
...
function SingleChart({ series }: { series: PurchasingReportSeries }) {
