            ...
            <tbody>
              {items.map((it) => (
                <tr key={it.id} className="border-b border-border/60 last:border-0">
                  ...
                  <td className="max-w-[14rem] truncate px-2 py-2 font-mono text-[11px] text-muted-foreground" title={it.orderReference || undefined}>
                    {it.orderReference || "—"}
                  </td>
                  ...
                  <td className={`whitespace-nowrap px-2 py-2 tabular-nums ${it.isExpired ? "text-destructive" : "text-muted-foreground"}`}>
