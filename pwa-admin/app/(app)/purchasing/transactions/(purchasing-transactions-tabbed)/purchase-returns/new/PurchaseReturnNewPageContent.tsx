...
import {
  getReceptionDetailForReturnAction,
  resolveReceptionBySupplierDocumentAction,
} from "@/features/receptions/actions/reception.action";
...
export default async function PurchaseReturnNewPageContent() {
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col" data-test-id="purchase-returns-new-page">
      <PurchaseDocumentBuilder
        ...
        fetchReceptionDetail={getReceptionDetailForReturnAction}
        resolveReceptionBySupplierDocument={resolveReceptionBySupplierDocumentAction}
