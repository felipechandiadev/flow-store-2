...
export default async function Page() {
  ...
  return (
    <div
      ...
      data-test-id="sales-transactions-payments-page-root"
    >
      <Suspense
        fallback={
          <LoadingState className="flex items-center justify-center py-4" data-test-id="sales-transactions-payments-page-skeleton" />
        }
      >
