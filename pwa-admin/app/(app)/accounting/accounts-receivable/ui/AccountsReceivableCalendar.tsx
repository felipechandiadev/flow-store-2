...
type Props = {
  ...
  onPay: (row: AccountsReceivableRow) => void;
  onDetails: (row: AccountsReceivableRow) => void;
};
...
export default function AccountsReceivableCalendar({ rows, onPay, onDetails }: Props) {
            ...
            <div className={`rounded-md border px-2 py-1 ${tone}`}>
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <div className="truncate font-mono text-[11px] text-muted-foreground">{doc}</div>
