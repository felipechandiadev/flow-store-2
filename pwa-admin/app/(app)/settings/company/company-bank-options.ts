...
export const COMPANY_BANK_OPTIONS: Option[] = [
...
export const COMPANY_ACCOUNT_TYPE_OPTIONS: Option[] = [
...
export function accountTypeOptionsForBank(bankName: string): Option[] {
  if (isBancoEstadoBank(bankName)) {
    return COMPANY_ACCOUNT_TYPE_OPTIONS;
  }
  return COMPANY_ACCOUNT_TYPE_OPTIONS.filter((o) => o.id !== CUENTA_RUT_ACCOUNT_TYPE_ID);
}
