...
Script para conectar el servidor con el repositorio **kai-suite** vía SSH.

## Repositorio

| Tipo | URL |
|------|-----|
| HTTPS | `https://github.com/felipechandiadev/kai-suite.git` |
| SSH | `git@github.com:felipechandiadev/kai-suite.git` |
...
1. [Settings → Deploy keys](https://github.com/felipechandiadev/kai-suite/settings/keys)
